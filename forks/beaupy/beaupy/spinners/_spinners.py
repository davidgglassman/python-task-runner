...
DIAMOND = ['◇', '◈', '◆']
DOT = ['⠁', '⠂', '⠄', '⡀', '⢀', '⠠', '⠐', '⠈']
DOTS = ['[bold green]⣾[/bold green]', '[bold green]⣽[/bold green]', '[bold green]⣻[/bold green]', '[bold green]⢿[/bold green]', '[bold green]⡿[/bold green]', '[bold green]⣟[/bold green]', '[bold green]⣯[/bold green]', '[bold green]⣷[/bold green]']
LINE = ['|', '/', '-', '\\']
